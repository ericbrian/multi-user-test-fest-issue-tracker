...
SSO via Microsoft Entra ID (Azure AD) is **always required**.

## What Changed

### 1. **SSO Required Everywhere**

- SSO configuration is mandatory for both development and production

### 2. **Removed Dev Auto-Auth Middleware**

- The development auto-authentication middleware has been removed
- There is no authentication bypass in development
